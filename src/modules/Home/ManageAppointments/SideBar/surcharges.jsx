...
const Surcharges = () => {
  return (
    <div className="w-[556px] h-[425px] px-6 py-5 flex-col justify-start items-start gap-5 inline-flex">
      ...
      <RowSurcharges label="Phí điện" unit="kwh" />
      <RowSurcharges label="Phí nước" unit="m3" />
      <RowSurcharges label="Phí giữ xe" unit="Xe" />
      <RowSurcharges label="Phí quản lý" unit="Phòng" />
