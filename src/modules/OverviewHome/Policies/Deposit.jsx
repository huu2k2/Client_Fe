...
const Deposit = ({data}) => {
  return (
    <div className="w-full self-stretch h-fit lg:h-[186px] bg-white rounded-lg shadow flex-col justify-start items-start flex">
      ...
      <div className="w-full self-stretch h-[121px] flex-col justify-center items-center flex">
        <div className="w-full self-stretch h-[60px] px-6 py-5 flex-col justify-center items-start flex">
          <div className="w-full lg:w-[1264px] h-5 justify-between items-center gap-4 inline-flex">
            ...
            <div className="w-fit lg:w-[838px] text-gray-900 text-sm font-normal  leading-tight">
              1 tháng
            </div>
          </div>
        </div>
